...
A 2D homogeneous domain containing a crack tip is illustrated in Figure. The geometry of the domain satisfies the scaling
...
\begin{align*}
    ...
    [N_{,\eta}(\eta)]
\end{align*}
The displacement functions {u(n)} are expressed as
\begin{align*}
