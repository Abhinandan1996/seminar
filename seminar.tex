...
\begin{figure}[H]
    ...
    \caption{load-elongation curve for fracture initiation and stable crack growth[1]}  
\end{figure}
...
\begin{figure}[H]
    ...
    %\captionsetup{labelformat=empty}
    \caption{word done to close the crack increment $\Delta a$[1]}
...
\begin{figure}[H]
    ...
    %\captionsetup{labelformat=empty}
    \caption{Thickness effect on fracture toughness[1]}
\end{figure}
...
\begin{figure}[H]
    ...
    %\captionsetup{labelformat=empty}
    \caption{Fracture stress as a function of crack tip radius[1]}
\end{figure}
...
\begin{figure}[H]
    ...
    %\captionsetup{labelformat=empty}
    \caption{Brittle inclusions ahead of a crack tip.[1]}
\end{figure}
...
\begin{figure}[H]
    ...
    %\captionsetup{labelformat=empty}
    \caption{Schematic diagrams of load vs load point displacement showing difference in fracture ductility[1]}
\end{figure}
...
\begin{figure}[H]
    ...
    %\captionsetup{labelformat=empty}
    \caption{Three-dimensional crack geometry.[2]}  
\end{figure}
...
\begin{figure}[H]
    ...
    %\captionsetup{labelformat=empty}
    \caption{Contrast between deterministic and probabilistic engineering analysis.[3]}  
\end{figure}
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=.4\textwidth]{s14.png}}
    %\captionsetup{labelformat=empty}
    \caption{Statistical variation of strength ($\sigma_f$) and applied stress ($\sigma$); failure possible over crosshatched region.[3]}  
\end{figure}
...
As shown in fig.9, statistical interpretation 
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=.33\textwidth]{s15.png}}
    %\captionsetup{labelformat=empty}
    \caption{2D cracked plate in scaled boundary coordinate[4]}  
\end{figure}
...
\begin{figure}[H]
    ...
    %\captionsetup{labelformat=empty}
    \caption{Displacement in scaled boundary coordinates[4]}  
\end{figure}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=.4\textwidth]{s17.png}}
    %\captionsetup{labelformat=empty}
    \caption{Perturbation in scaled boundary coordinates[4]}  
\end{figure}
...
\begin{figure}[H]
    ...
    %\captionsetup{labelformat=empty}
    \caption{Probability distribution of turbine rotor spindle alternating stress level[3]}  
\end{figure}
...
&\text{where $N_i$ is proportional to $D$, a dimensionless random
...
\begin{figure}[H]
    ...
    %\captionsetup{labelformat=empty} 
    \caption{Probability distribution of fatigue lifetime of defected turbine rotor spindle[3]} 
\end{figure}
...
\end{align*}
Inevitably, the MCS method would require a sufficient number of entries in the response matrix [$K_s$ ] for a reliable 
...
\rule{\textwidth}{.1em}
\section{Conclusion}
$\Rightarrow$ Fracture initiation and stable crack growth are local fracture phenomena.
...
parameters. A data base of input parameter probability distributions can be formed to
